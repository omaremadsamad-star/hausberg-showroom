  ...
  return (
    <section id="products-section" className="py-24 bg-[#07070a] min-h-screen">
      <div id="products-grid-section" className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        {/* Shimmering Gold Skeleton Cards Loader */}
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {Array.from({ length: 8 }).map((_, idx) => (
              <div 
                key={idx} 
                className="bg-[#0f0f15]/40 rounded-2xl border border-neutral-900 overflow-hidden flex flex-col h-full space-y-4 p-4"
              >
                {/* Image Aspect ratio skeleton */}
                <div className="aspect-4/3 w-full rounded-xl animate-shimmer" />
                ...
                <div className="pt-4 border-t border-neutral-900/40 flex justify-between items-center">
